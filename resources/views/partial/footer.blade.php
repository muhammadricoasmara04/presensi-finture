        ...
        <section class="footer-dark">
            <div class="container">
                <div class="footer-wrapper">
                    <a href="#" class="footer-brand w-inline-block"><img src="img/logofirts.png" loading="lazy"
                            alt=""></a>
                    <a href="#" class="footer-brand w-inline-block"><img src="img/fintura.png" loading="lazy"
                            alt=""></a>
                    <div class="footer-content">
                        <div id="w-node-ffe04577-da86-50be-cf84-601ad01ee2b5-d273f61f" class="footer-block">
                            <div class="title-small">Finture</div>
                            <a href="#" class="footer-link">How it works</a>
                            <a href="#" class="footer-link">Pricing</a>
                            <a href="#" class="footer-link">Docs</a>
                        </div>
                        <div id="w-node-ffe04577-da86-50be-cf84-601ad01ee2be-d273f61f" class="footer-block">
                        ...
                        <div id="w-node-ffe04577-da86-50be-cf84-601ad01ee2c9-d273f61f" class="footer-block">
